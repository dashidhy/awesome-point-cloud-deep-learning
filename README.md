...
- **PointNet: Deep Learning on Point Sets for 3D Classification and Segmentation** (CVPR 2017), C. Qi et al. [[pdf]](https://arxiv.org/pdf/1612.00593.pdf) [[Github]](https://github.com/charlesq34/pointnet) :star: :star: :star: :star: :star:
- **PointNet++: Deep Hierarchical Feature Learning on Point Sets in a Metric Space** (NeurIPS 2017), C. Qi et al. [[pdf]](https://arxiv.org/pdf/1706.02413.pdf) [[Github]](https://github.com/charlesq34/pointnet2) :star: :star: :star: :star: :star:
...
- **Deep Hough Voting for 3D Object Detection in Point Clouds** (Arxiv 2019) C. Qi et al. [[pdf]](https://arxiv.org/pdf/1904.09664.pdf) :star: :star: :star: :star: :star:
- ... (To be completed, a useful resource is the learderboard of [KITTI Benchmark](http://www.cvlibs.net/datasets/kitti/eval_object.php?obj_benchmark=3d))
